...
import (
	...
	"github.com/Mond1c/lms/services/submission/internal/config"
	"github.com/Mond1c/lms/services/submission/internal/handler"
...
func New(ctx context.Context, cfg *config.Config) (*App, error) {
	...
	path, h := lmsv1connect.NewSubmissionServiceHandler(handler.New())
	mux.Handle(path, h)
