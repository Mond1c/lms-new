...
type mockUsersRepo struct {
	...
	updateFn     func(ctx context.Context, u domain.UserUpdate) (*domain.User, error)
}
...
func (m *mockUsersRepo) Update(ctx context.Context, u domain.UserUpdate) (*domain.User, error) {
