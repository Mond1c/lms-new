...
import (
	...
	"github.com/Mond1c/lms/services/grading/internal/config"
	"github.com/Mond1c/lms/services/grading/internal/handler"
...
func New(ctx context.Context, cfg *config.Config) (*App, error) {
	...
	path, h := lmsv1connect.NewGradingServiceHandler(handler.New())
	mux.Handle(path, h)
